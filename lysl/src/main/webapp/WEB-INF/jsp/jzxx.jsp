...
<script>
    layui.use('table', function () {
        ...
        table.render({
            elem: '#test'
            , url: 'http://47.113.115.120:8080/donationOrder/queryDonationOrderByStatusByPage'
        ...
        table.on('tool(test)', function (obj) {
            ...
            if (obj.event === 'shtg') {
                ...
                $.ajax({
                    type: "GET",
                    url: "http://47.113.115.120:8080/donationOrder/checkDonationOrder?donationOrderId=" + id + "&status=APPROVED",
